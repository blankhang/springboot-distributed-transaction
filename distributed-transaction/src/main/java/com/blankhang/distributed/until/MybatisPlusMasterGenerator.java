...
/**
 * mybatis plus  自动代码生成 Master DB 使用
 * 自动基于指定表生成 model mapper controller service
 *
 * @author blank
 * @date 2020-7-29 下午 12:19
 */
public class MybatisPlusMasterGenerator {

    /**
     * 是否生成代码到项目位置
     * 如要生成到D:/java 这里改成 false 即可
     */
...
//        dsc.setPassword("rCgRgLjH99Xvg5BN");
        ...
        dsc.setUrl("jdbc:mysql://192.168.1.101:39091/master?useSSL=false&autoReconnect=true&useUnicode=true&characterEncoding=UTF-8");
        dsc.setUsername("blank");
        dsc.setPassword("pS4Jy3bG6kdLDTbDLYVj");
...
//         strategy.setSuperServiceImplClass("com.storlead.sc.web.service.impl.BaseServiceImpl");
        ...
        pc.setService("com.blankhang.distributed.service.master");
        pc.setServiceImpl("com.blankhang.distributed.service.master.impl");
        pc.setXml("com.storlead.distributed.mapper.master");
        pc.setMapper("com.blankhang.distributed.mapper.master");
        pc.setEntity("com.blankhang.distributed.entity.master");
        ...
        focList.add(new FileOutConfig(templatePath) {
            ...
            public String outputFile(TableInfo tableInfo) {
                if(WRITE_FILE_TO_PROJECT) {
                    ...
                    return projectPath + "/distributed-transaction/src/main/resources/mapper/master/" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
                } else {
                    //生成到D盘\java 目录
                    return "D:\\java\\com\\blankhang\\mapper\\master\\" + tableInfo.getEntityName() + "Mapper" + StringPool.DOT_XML;
                }
            }
        });
